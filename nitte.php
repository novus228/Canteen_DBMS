<?php
		...
		$veg="";
		$food_price="";
		$query = "select food.* from food where CAN_ID=1";
		$q1 = "set @p='100'";
		$q2 = "call test1(@p,@a);";
		$q3 = "select @a as no;";
		?>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.php">Nitte Canteen</a></div>
				<ul class="nav navbar-nav navbar-right">
				<li class="nav-item">
					<a class="nav-link" href="empnitte.php">Our Employees</a>
				</li>
			</ul>
...
<center><a href="nitteorder.php"><button type="submit" name="login" class="btn btn-primary">ORDER NOW!</button></a></center>
<br><br>
</body>
</html>